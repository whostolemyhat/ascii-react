                ...
                <form>
                    <label>
                        <input
                            ...
                            value="no"
                            name="noWorker"
                            checked={this.state.workerOption === "no"}
                        />{" "}
                        No worker
                    </label>
                    <label>
                        <input
                            ...
                            value="one"
                            name="singleWorker"
                            checked={this.state.workerOption === "one"}
                        />{" "}
                        Single worker
                    </label>
                    <label>
                        <input
                            ...
                            value="multi"
                            name="singleWorker"
                            checked={this.state.workerOption === "multi"}
                        />{" "}
                        Multi worker
                    </label>
                    <input
                        ...
                        onChange={this.handleNumWorkerChange}
                    />{" "}
                    {this.state.numWorkers}
                </form>
